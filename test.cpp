...
//             reference operator*(){return value->item;}
...
//             // this function needs the const_iterator class
//             friend iterator operator+(size_t n, iterator& rhs){
//                 while(n--){
//                     ++rhs;
//                 }
//                 return rhs;
...
// /*
//     can't print those lines
//     cout << List<int>::iterator::difference_type << endl;
//     cout << List<char>::iterator::difference_type << endl;
//     cout << List<float>::iterator::difference_type << endl;
// */
